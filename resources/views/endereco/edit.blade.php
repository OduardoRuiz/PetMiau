...
<body>
    ...
    <form action="{{ route('endereco.update', $endereco->id) }}" method="post">
        ...
        <div class="form-group campoDigitar">
            ...
            <input type="text" name="contato" onkeypress="soNumero(this.id)" value="{{$endereco->contato}}" class="form-control" id="telefone" pattern="(\([0-9]{2}\))\s([9]{1})?([0-9]{4})-([0-9]{4})" placeholder="Contato - (Somente números)" required="required" maxlength="15">
        </div>
